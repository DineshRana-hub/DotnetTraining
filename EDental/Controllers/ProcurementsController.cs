...
namespace EDental.Controllers
{
    public class ProcurementsController : Controller
    {
        ...
        {
            return View(await _context.Procurement.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var procurement = await _context.Procurement
        ...
        public async Task<IActionResult> Create([Bind("Id,Particulars,Vendor,Price,Quantity,Warranty,Date")] Procurement procurement)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var procurement = await _context.Procurement.FindAsync(id);
            if (procurement == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Particulars,Vendor,Price,Quantity,Warranty,Date")] Procurement procurement)
        {
