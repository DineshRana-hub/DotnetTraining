...
namespace EDental.Controllers
{
    public class DiagnosesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Procedures,Medication")] Diagnosis diagnosis)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Procedures,Medication")] Diagnosis diagnosis)
        {
            if (id != diagnosis.Id)
            {
                return NotFound();
